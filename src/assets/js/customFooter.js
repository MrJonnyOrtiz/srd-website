...
export const myFooter = () => {
   document.addEventListener("DOMContentLoaded", function () {
      const footerEl = document.getElementById("theFooter");
      footerEl.insertAdjacentHTML(
         ...
         '<footer class="w-100 py-4 flex-shrink-0">' +
            ...
            '<h2 class="h5 text-white mb-3">Quick links</h2>' +
            ...
            '<ul class="list-unstyled text-white">' +
            "<li>" +
            '<a class="nav-link" href="https://www.facebook.com/profile.php?id=100070092405409" target="_blank" rel="noreferrer" rel="noopener">Facebook ' +
         ...
         // +
         // '<li><a class="nav-link" href="#">Instagram <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-youtube" viewBox="0 0 16 16">' +
